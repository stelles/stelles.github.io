...
argument-hint: Analyze recently modified code and apply refinements that enhance clarity and maintainability without changing functionality. Follow project-specific coding standards and best practices.
model: GPT-5.2-Codex
---
